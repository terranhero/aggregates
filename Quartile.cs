...
public struct Quartile : IBinarySerialize
{
	...
	/// 4 最大值
	/// </param>
	public void Accumulate(SqlDecimal Value, int quert)
	{
		if (Value.IsNull) { return; }
		datas.Add(Value); _quert = quert;
	}

	/// <summary>聚合函数实例合并</summary>
	/// <param name="Group">需要合并的 Quartile 类实例。</param>
	public void Merge(Quartile Group)
	{
	...
	public SqlDecimal Terminate()
	{
		...
		double quart = (datas.Count - 1) * 3 / 4 + 1;
