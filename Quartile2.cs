...
[Serializable, SqlUserDefinedAggregate(Format.UserDefined, IsInvariantToDuplicates = false, IsInvariantToNulls = true,
	IsInvariantToOrder = false, MaxByteSize = 8000, Name = "SYSF_QUARTILE2")]
public struct Quartile2 : IBinarySerialize
{
	...
	public void Merge(Quartile2 Group)
	{
	...
	public SqlDecimal Terminate()
	{
		...
		double quart = (datas.Count - 1) * 2 / 4 + 1;
